...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Category&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.rank, rank) || other.rank == rank));
}
...
@override
String toString() {
  return 'Category(id: $id, title: $title, imageUrl: $imageUrl, rank: $rank)';
}
...
class _Category extends Category {
  const _Category({required this.id, required this.title, required this.imageUrl, this.rank = 0}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Category&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.rank, rank) || other.rank == rank));
}
